...
public class SeeAlso implements TagInterface{
    ...
    public MutableText toText() {
        MutableText result = Text.empty().append(Text.translatable("command-utils.command.docs.tag.see-also").formatted(Formatting.GOLD, Formatting.BOLD));
