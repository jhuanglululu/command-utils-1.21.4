...
public class Reference implements TagInterface{
    ...
    public MutableText toText() {
        MutableText result = Text.empty().append(Text.translatable("command-utils.command.docs.tag.reference").formatted(Formatting.GOLD, Formatting.BOLD));
