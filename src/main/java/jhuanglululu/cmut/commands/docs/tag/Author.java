...
public class Author implements TagInterface{
    ...
    public MutableText toText() {
        MutableText result = Text.empty().append(Text.translatable("command-utils.command.docs.tag.author").formatted(Formatting.GOLD, Formatting.BOLD));
