...
public class Require implements TagInterface{
    ...
    public MutableText toText() {
        MutableText result = Text.empty().append(Text.translatable("command-utils.command.docs.tag.require").formatted(Formatting.GOLD, Formatting.BOLD));
