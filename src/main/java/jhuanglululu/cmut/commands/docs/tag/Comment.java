...
public class Comment implements TagInterface{
    ...
    public MutableText toText() {
        MutableText result = Text.empty().append(Text.translatable("command-utils.command.docs.tag.comment").formatted(Formatting.GOLD, Formatting.BOLD));
