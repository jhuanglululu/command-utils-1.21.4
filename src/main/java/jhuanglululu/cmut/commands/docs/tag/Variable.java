...
public class Variable implements TagInterface{
    ...
    public MutableText toText() {
        MutableText result = Text.empty().append(Text.translatable("command-utils.command.docs.tag.variable").formatted(Formatting.GOLD, Formatting.BOLD));
