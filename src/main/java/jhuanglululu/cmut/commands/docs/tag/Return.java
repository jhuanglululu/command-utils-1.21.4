...
public class Return implements TagInterface{
    ...
    public MutableText toText() {
        MutableText result = Text.empty().append(Text.translatable("command-utils.command.docs.tag.return").formatted(Formatting.GOLD, Formatting.BOLD));
